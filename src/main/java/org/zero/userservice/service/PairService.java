...
public class PairService {
  ...
  public String createPair(PairRequest pair, String idempotencyKey, String issuerId) {
    ...
    var idempotencyCheckValue =
        IdempotencyValueProvider.generate(pair.userId(), pair.warehouseRef());
  ...
  private String savePair(
      String idempotencyKey, ContactWarehousePair newPair, String idempotencyCheckValue) {
  ...
  private ContactWarehousePair getContactWarehousePair(
      PairRequest pair, Integer contactPersonId, String pairHash) {
